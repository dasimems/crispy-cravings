...
function Home(props) {
  ...
  useEffect(() => {
    var productList = products.filter(
      (prod) => prod.category.name === presentCat
    );
    ...
    <>
      ...
      <Row justify="center" className="popular-dishes">
        <Col span={22}>
          <Row
            ...
            className="popular-dishes-header align-center"
          >
          ...
          <Row justify="center">
            ...
            >
              ...
              <p className="service-description">
                This is a type of restuarant which typically serves food and
                drinks, in addition to light refreshments such as baked goods or
                snacks
              </p>
                ...
                <Row justify="space-between">
                  {service.map((serviceContent, index) => {
                    ...
                    return (
                      ...
                      >
                        <div className="service-card-image">{icon}</div>
      ...
      <Row justify="center" className="menu-pack">
        <Col span={22}>
          ...
          {products.length > 8 && (
            <Row justify="end" className="menu-action">
